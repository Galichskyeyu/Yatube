...
class PostTests(TestCase):
    ...
    def test_create_post_edit_show_correct_context(self):
        """Шаблон редактирования записи /create_post сформирован
    ...
    def test_create_post_show_correct_context(self):
        """Шаблон создания записи /create_post сформирован
        с правильным контекстом.
        """
    ...
    def test_create_post_show_home_group_list_profile_pages(self):
        """Созданный пост отобразился на главной странице сайта,
    ...
    def test_profile_follow(self):
        ...
        self.auth_client.get(self.URLS['PROFILE_FOLLOW'])
    ...
    def test_profile_unfollow(self):
        ...
        self.assertTrue(Follow.objects.filter(user=self.user,
                                              author=self.user_2).exists())
        self.auth_client.get(self.URLS['PROFILE_UNFOLLOW'])
        self.assertFalse(Follow.objects.filter(user=self.user,
                                               author=self.user_2).exists())
